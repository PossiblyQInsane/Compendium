...
modified: 2026-07-27T19:34:17.713-04:00
published: 2026-07-27T19:34:17.713-04:00
tags:
  - Official
Source:
...
Before you can cast a spell, you must have the spell prepared in your mind or have access to the spell from a magic item, such as a _[[Spell Scroll]]_. Your features specify which spells you have access to, if any; whether you always have certain spells prepared; and whether you can change the list of spells you have prepared.
...
**Magic Items.** _[[Spell Scroll|Spell Scrolls]]_ and some other magic items contain spells that can be cast without a spell slot. The description of such an item specifies how many times a spell can be cast from it.
...
Most spells require the [[Magic|Magic]] action to cast, but some spells require a Bonus Action, a Reaction, or 1 minute or more. A spell’s Casting Time entry specifies which of those is required.

#### One Spell with a Spell Slot per Turn

On a turn, you can expend only one spell slot to cast a spell. This rule means you can’t, for example, cast a spell with a spell slot using the [[Magic|Magic]] action and another one using a Bonus Action on the same turn.
...
_**A Clear Path to the Target.**_ To target something with a spell, a caster must have a clear path to it, so it can’t be behind [[Cover|Total Cover]].
...
<div align="center">
<span style="font-weight: bold">Spell save DC</span> = 8 + your spellcasting ability modifier + your Proficiency Bonus
</div>
#### Attack Rolls
...
<div align="center">
<span style="font-weight: bold">Spell attack modifier</span> = your spellcasting ability modifier + your Proficiency Bonus
</div>
