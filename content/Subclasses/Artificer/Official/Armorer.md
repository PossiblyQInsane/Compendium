...
***Tool Proficiency.*** You gain proficiency with [[Smith's Tools]]. If you already have this tool proficiency, you gain proficiency with one other type of [[Artisan's Tools|Artisan's Tools]] of your choice.

***Armor Crafting.*** When you [[Crafting Equipment|craft]] nonmagical or magic armor, the amount of time required to craft it is halved.
...
***Armor Replication.*** You learn an additional plan for your [[Artificer#Level 2 Replicate Magic Item|Replicate Magic Item]] feature, and it must be in the Armor category. If you replace that plan, you must replace it with another Armor plan.
