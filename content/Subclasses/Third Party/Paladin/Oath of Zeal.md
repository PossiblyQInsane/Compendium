...
> [!caption|right wm-sm]
> ![[Images/Oath of Zeal.png]]

_Eliminate Threats to Ideological Purity_
...
For 1 minute, your weapon attacks and [[Unarmed Strike|Unarmed Strikes]] against the chosen creature can score a [[Critical Hit]] on a roll of 19 or 20 on the d20. In addition, whenever the target starts its turn, you can take a [[Reaction]] to make a melee attack against that creature if it’s within reach.
...
| :-----------: | ----------------------------------------------- |
|       3       | _[[Detect Evil and Good]]_, _[[Hunter's Mark]]_ |
|       5       | _[[Detect Thoughts]]_, _[[Knock]]_              |
|       9       | _[[Fear]]_, _[[Tongues]]_                       |
|      13       | _[[Divination]]_, _[[Locate Creature]]_         |
|      17       | _[[Insect Plague]]_, _[[Scrying]]_              |
...
You can cast _[[Zone of Truth]]_ without expending a spell slot. In addition, a creature that succeeds on its saving throw takes 1d6 Psychic damage at the start of each of its turns while in your _Zone of Truth_ until it chooses to fail its saving throw instead.
...
**_Blinding Glory._** Enemies that start their turn within 5 feet of you must make a Constitution saving throw against the Paladin's spell save DC. On a failed save, the creature has the [[Blinded]] condition until the start of its next turn.

**_See the Truth._** You have [[Truesight]] with a range of 60 feet.

**_Smite the Heretic._** As a Bonus Action, you can choose a creature within 60 feet of yourself and reveal its weaknesses. You and your allies have [[Advantage]] on attack rolls against that creature.
