...
> [!caption|left ws-med]
> ![[Images/Grim Harbinger.png]]

_Seal Fate as an Omen of Doom_
...
You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [[Short Rest|Short]] or [[Long Rest]]. You can also expend a spell slot to restore an expended use (no action required).
...
**_Graveyard Hunter._** The Grim’s Ominous Rend action deals an extra 1d6 Necrotic damage on a hit.

**_Mortal Reminder._** When you deal damage to a creature doomed by your Omen of Doom, you can change the damage type to Necrotic.

**_Mounting Dread._** Necrotic damage dealt by you or the grim ignores [[Resistance]].

### Level 11: Grave Bond

You draw deeper strength from the grave. You gain the following benefits.

**_Graveyard Hunter._** The grim gains [[Resistance]] to Bludgeoning, Piercing, and Slashing damage.

**_Grave Fortitude._** You gain Resistance to Necrotic damage.

**_Inescapable Fate._** When the target of your Omen of Doom succeeds on a saving throw, you can take a [[Reaction]] to force it to reroll the save with [[Disadvantage]] and use the new roll. Once you cause a save to fail with this benefit, you can’t use it again until the current Omen of Doom ends.
