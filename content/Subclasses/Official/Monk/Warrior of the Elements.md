...
> [!caption|left ws-med]
> ![[Images/Warrior of the Elements.png]]
...
**_Reach._** When you make an [[Unarmed Strike]], your reach is 10 feet greater than normal, as elemental energy extends from you.
...
You know the _[[Elementalism]]_ spell. Wisdom is your spellcasting ability for it.
...
**_Empowered Strikes._** Once on each of your turns, you can deal extra damage to a target equal to one roll of your Martial Arts die when you hit it with an [[Unarmed Strike]]. The extra damage is the same type dealt by that strike.
